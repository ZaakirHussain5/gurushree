...
from .models import professional, ConsultantSlutMaster, Department, hospital, discounType, service
# Register your models here.
# admin.site.site_header = 'Gurushree Admin Panel' 
admin.empty_value_display = '**Empty**'
admin.site.register((ConsultantSlutMaster, Department, hospital, discounType, service ))
